...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_CreateObjectInfo_2eproto[2];
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_CreateObjectInfo_2eproto_sccs[2] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_CreateObjectInfo_2eproto = {
  &descriptor_table_CreateObjectInfo_2eproto_initialized, descriptor_table_protodef_CreateObjectInfo_2eproto, "CreateObjectInfo.proto", 169,
  &descriptor_table_CreateObjectInfo_2eproto_once, descriptor_table_CreateObjectInfo_2eproto_sccs, descriptor_table_CreateObjectInfo_2eproto_deps, 2, 0,
  schemas, file_default_instances, TableStruct_CreateObjectInfo_2eproto::offsets,
  file_level_metadata_CreateObjectInfo_2eproto, 2, file_level_enum_descriptors_CreateObjectInfo_2eproto, file_level_service_descriptors_CreateObjectInfo_2eproto,
};
